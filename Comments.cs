            ...
            if (int.TryParse(idtxt.Text, out requestId))
            {
                using (SqlConnection connection = new SqlConnection(DatabaseConfig.connectionString))
                {
                    ...
                    try
                    {
                        ...
                        if (currentStatusID == 1 || currentStatusID == 2 || currentStatusID == 5 || currentStatusID == 6)
                        {
                            ...
                            string updateQuery = "UPDATE Requests SET StatusID = 6 WHERE RequestID = @RequestID";
                            ...
                            notestxt.Text = "";
                            idtxt.Text = "";
                            MessageBox.Show("تم اضافه الملاحظه بنجاح");
                        }
                        else
                        {
