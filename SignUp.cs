         ...
         { "OfficerManager", -1 }
            ...
            using (SqlConnection connection = new SqlConnection(DatabaseConfig.connectionString))
            {
                try
                {
                    ...
                    string query = "INSERT INTO Users (Username, Password, RoleID , Fullname) VALUES (@Username, @PasswordHash, @RoleID , @Fullname)";
                    using (SqlCommand command = new SqlCommand(query, connection))
                    {
                        ...
                        command.Parameters.AddWithValue("@Fullname", Fullnametxt.Text);// Use the roleID from the dictionary
